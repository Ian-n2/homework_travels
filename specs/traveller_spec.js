...
describe('Traveller', function() {
 ...
 traveller.getJourneysByTransport('train')
    const expected = [
      journey1,
      journey2
    ];
...
traveller.getJourneysByMinDistance(1000)
    const expected = [
      journey3,
      journey4
    ];
  ...
  it('should be able to calculate total distance travelled', function() {
    traveller.calculateTotalDistanceTravelled()
  ...
  it('should be able to get a unique list of the modes of transport', function() {
    traveller.getUniqueModesOfTransport()
